...
* **Автоматизация** - "Слава роботам"(с) Бендер. Человек задействован минимально, появляются различные _* as Service_ и позволяют другим людям автоматизировать их работу.
...
Мы то с вами помним, что инфраструктура эволюционирует и формализуется в скрипты и/или множество _* as Service_. А с этим можно работать как с кодом и переиспользовать практики по рефакторингу кода. Из предыдущих сценариев выбивается нечто общее:
...
* [English Version](aac-en.md)
* [Cross posrt](https://habr.com/en/post/522702/)
